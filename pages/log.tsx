...
export default function Log() {
  ...
  return (
    <Layout>
      <div className="px-5 xs:px-7 sm:px-10 mx-auto">
        ...
        {isLargeScreen ? (
          <div className="overflow-x-hidden">
            <table
              className="table-auto w-full max-w-[1200px] border-separate bg-[#F6F6F6] rounded-3xl border border-[#E5E7EB] px-5 text-[16px]"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 w-full gap-2 xs:gap-3 text-[13px] xs:text-[14px]">
