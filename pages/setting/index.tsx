      ...
      <div className="px-5 xs:px-7 sm:px-10">
        ...
        <div className="flex flex-row justify-between items-center w-full max-w-[700px] px-1 mt-3 xs:mt-4 sm:mt-5">
          ...
          <Image
            ...
            width={25}
            height={22}
            className="w-[19px] h-[16px] xs:w-[22px] xs:h-[19px] sm:w-[25px] sm:h-[22px]"
          />
        </div>
        ...
        <div className="flex flex-row justify-end items-center w-full max-w-[700px] font-semibold mt-5 xs:mt-6 sm:mt-7">
